...
export default function NpcDialog({ line, speaker = "George", hasNext, onAdvance }: NpcDialogProps) {
  return (
    <AnimatePresence>
      {line !== null && (
        <motion.div
          ...
          onClick={onAdvance}
          className="fixed bottom-10 left-1/2 z-50 w-[min(560px,92vw)] -translate-x-1/2 cursor-pointer select-none rounded-2xl border-2 border-sage bg-parchment px-5 py-4 shadow-[0_8px_40px_rgba(28,21,8,0.35)]"
        >
