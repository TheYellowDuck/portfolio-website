// Pure résumé-text parser (extracted from the /api/resume route so it can be unit
// tested without pdf-parse). Input is the plain text pdf-parse extracts from the
// résumé PDF — tabs separate left/right columns; "•" marks bullets.
